...
async function fixture() {
  ...
  // Whole-copy discovery uses its own database and requires getAllKeys, which
  // the older single-copy IDB double does not implement.
  ...
  const api = actual(["adminTemplatePhotoCopyStore", "adminTemplatePhotoTreeCopyInventory", "readAdminTemplatePhotoWholeCopyAccepted",
