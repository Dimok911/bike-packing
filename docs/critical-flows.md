...
- Сетевой таймаут или отсутствие связи, пойманные общим API-клиентом, должны сразу давать красную/оранжевую точку на кнопке синхронизации и постоянную видимую плашку. Нельзя оставлять такую ошибку только в консоли; индикатор снимается после успешного ответа сервера.
