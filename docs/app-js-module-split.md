...
- `src/sync` has the API client helpers, history helpers, payload reporting, photo metadata/cache helpers, state serialization helpers, and entity sync payload helpers.
