...
function normalizeSyncMeta(meta, {
  ...
  return {
    ...
    listId: meta.listId || meta.currentListId || null,
    currentListId: meta.currentListId || meta.listId || null,
    ...
    cacheIntegrityVersion: Number(meta.cacheIntegrityVersion) || 0,
